...
export function NftCard({img, name, currentBid}) {
    ...
    return (
        ...
        <div className="h-[252.9px] w-[252.9px]">
            ...
            <div className="absolute -mt-[238.7px] ml-[127.03px] h-[37.64px] w-[116.58px] font-[500] bg-[#1C1D2059] border border-[#1C1D2014] shadow-[4.72px] rounded-[9.41px] px-[14.29px] py-[8.32px] text-[14.12px] text-white text-center">
